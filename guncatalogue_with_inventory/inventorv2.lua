copy this into your redemrp_inventory config.
--PISTOLS
Config.Items = {
  ...
  ["WEAPON_REPEATER_WINCHESTER"] = {
      ...
      imgsrc = "items/WEAPON_REPEATER_WINCHESTER.png",
      type = "item_weapon"
  },
  --RIFLES
  ...
  ["WEAPON_MELEE_LANTERN"] = {
      ...
      imgsrc = "items/WEAPON_MELEE_LANTERN.png",
      type = "item_weapon"
  },
  ["WEAPON_BOW"] = {
      label = "Bow",
  ...
  ["repeator_ammo"] = {
      ...
      limit = 64,
      type = "item_standard",
      imgsrc = "items/repeator_ammo.png"
  },
  ["snipe_ammo"] = {
      label = "Sniper Ammo",
